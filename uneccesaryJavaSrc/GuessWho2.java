...
//	            TimeUnit.MILLISECONDS.sleep(timeout);
            ...
            log.add("--------------------------------------------------------");
            log.add("\n");
            log.add("Results for running game " + numberOfRuns + " times, are:");
            log.add("P1 - Type: " + player1Type + " - Won: " + P1Wins + " times.");
            log.add("P2 - Type: " + player2Type + " - Won: " + P2Wins + " times.");
            log.add("It was a tie " + tie + " times.");
		}
...
class MoveLogg
{
     ...
     */
    public MoveLogg(String outFilename) throws IOException {
